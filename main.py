...
display_tela = Frame(janela, width=243, height=50, bg=cor2)
...
label_app = Label(display_tela, textvariable=valor_texto, width=23, height=3, padx=10, relief=FLAT, anchor="e", justify=RIGHT, font="Ivy 13 bold", bg=cor2, )
...
b_1.place(x=3, y=3)
b_1 = Button(display_corpo, command=lambda: entrada_valores("%"), text="%",bg=cor3, width=4, height=2, font="Ivy 14 bold", relief=RAISED, overrelief=RIDGE)
b_1.place(x=123, y=3)
b_1 = Button(display_corpo, command=lambda: entrada_valores("/"), text="/",bg=cor3, width=4, height=2, font="Ivy 14 bold", relief=RAISED, overrelief=RIDGE)
b_1.place(x=183, y=3)
...
b_9 = Button(display_corpo, command=lambda: entrada_valores("-"), text="-",bg=cor3, width=4, height=2, font="Ivy 14 bold", relief=RAISED, overrelief=RIDGE)
...
b_13 = Button(display_corpo, command=lambda: entrada_valores("+"), text="+",bg=cor3, width=4, height=2, font="Ivy 14 bold", relief=RAISED, overrelief=RIDGE)
...
b_16 = Button(display_corpo, command=calcular, text="=",bg=cor3, width=4, height=2, font="Ivy 14 bold", relief=RAISED, overrelief=RIDGE)
